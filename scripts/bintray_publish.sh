...
$TRAVIS_BUILD_DIR/scripts/jfrog bt u --publish --deb=$DEBIAN_DISTRO/$DEBIAN_COMP/$DEBIAN_ARCH $PACKAGE_PATH $BINTRAY_USER/$BINTRAY_REPO/$BINTRAY_PACKAGE/$BUILD_VERSION
